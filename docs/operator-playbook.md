...
**MRB:** [Issue #1](https://github.com/SimonBarnett/AgentMonitor/issues/1) (Bob chairs). This document does **not** stamp ready for human UAT.
...
- Exact Desktop shortcut icon paths on each fleet machine (repo `shortcuts/` is empty).
