...
1. Read issue #40. A1–A5 are on `main` via PR #38 (`b7e3db5`). MRB #55 required fixes are process-only: leave PR #53 and PR #49 closed; do not revert `07abe04` off `main`; no further #40 product change; no #40/#50 FIX worker.
...
- PR #49 and PR #53 stay closed. `main` retains `Disconnect-WatchIrc` / `quit.req` (issue #43).
