...
**MRB:** [Issue #50](https://github.com/SimonBarnett/AgentMonitor/issues/50) (Bob chairs). **Land:** [PR #38](https://github.com/SimonBarnett/AgentMonitor/pull/38) (`b7e3db5`, merged 2026-09-23). [PR #49](https://github.com/SimonBarnett/AgentMonitor/pull/49) (`89f30f85`) reverted `#43` product on a leftover FIX branch; stays **closed**; do not merge. No UAT.
...
Historical only: launchers passed `-Windows on`; no in-repo skill pack. Closed on `main` via PR #38 (`b7e3db5`). Issue #43 (`07abe04`, TUI-exit PART+QUIT) is separate product on `main`; not a #40 MUST.
